...
class WaveLoadingIndicator: UIView {
    ...
    private let heavyColor = UIColor(red:0.53, green:0.71, blue:0.91, alpha:1.00)
    private let lightColor = UIColor(red: 99.2/255.0, green: 149.7/255.0, blue: 235.9/255.0, alpha: 0.35)
