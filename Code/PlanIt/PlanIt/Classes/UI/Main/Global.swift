...
///导航栏背景色
let navigationBackground = UIColor ( red: 0.9294, green: 0.9294, blue: 0.9255, alpha: 1.0 )
///导航栏控件颜色
...
///未开始字体颜色
let overTimeFontColor = UIColor ( red: 0.898, green: 0.1961, blue: 0.251, alpha: 1.0 )